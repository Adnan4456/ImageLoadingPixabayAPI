...
public abstract class Hilt_MainNavHostFragment extends NavHostFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MainNavHostFragment_GeneratedInjector) this.generatedComponent()).injectMainNavHostFragment(UnsafeCasts.<MainNavHostFragment>unsafeCast(this));
    }
  }
