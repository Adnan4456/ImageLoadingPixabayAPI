...
public abstract class Hilt_ImageFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ImageFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ImageFragment_GeneratedInjector) this.generatedComponent()).injectImageFragment(UnsafeCasts.<ImageFragment>unsafeCast(this));
    }
  }
